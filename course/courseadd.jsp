						...
						<form class="form-horizontal" action="${url }" method="post" onsubmit="return checkform()">
							<fieldset>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input  type='text' placeholder='请输入课程名'  name='cname' id='cnameid' class="input-xlarge focused" />
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input  type='text' placeholder='请输入学分'  name='credit' id='creditid' class="input-xlarge focused" />
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input  type='text' placeholder='请输入学时'  name='classhours' id='classhoursid' class="input-xlarge focused" />
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <textarea class="input-xlarge textarea" placeholder='请输入课程简介' name="introduction"  style="width: 500px; height: 150px"></textarea>
								</div>
							  </div>
