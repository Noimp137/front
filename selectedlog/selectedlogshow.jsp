					...
					<div class="box-content">
						<form class="form-horizontal" action="${url }" method="post" onsubmit="return checkform()">
							...
							<div class="control-group">
							  ...
							  <div class="control-group">
								<label class="control-label" for="focusedInput">审核时间</label>
								<div class="controls">
								  <input class="input-xlarge focused" type='text' value="${bean.stime }"  readonly="readonly" />
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <textarea class="input-xlarge textarea"  readonly="readonly" name="result"  style="width: 500px; height: 150px">${bean.feedback }</textarea>
								</div>
							  </div>
							  
							  
							  <div class="control-group">
								<label class="control-label" for="focusedInput">领取数量</label>
								<div class="controls">
								  <input class="input-xlarge focused" type='text' value="${bean.snumber }"  readonly="readonly" />
								</div>
							  </div>
							  ...
							  <div class="control-group">
								<label class="control-label" for="focusedInput">领取时间</label>
								<div class="controls">
								  <input class="input-xlarge focused" type='text' value="${bean.receivetime }"  readonly="readonly" />
								</div>
							  </div>
