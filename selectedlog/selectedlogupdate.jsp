						...
						<form class="form-horizontal" action="${url }" method="post" onsubmit="return checkform()">
							<fieldset>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								 <input class="input-xlarge focused" type='text' value="${bean.cname }" readonly="readonly"  name=' />
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" type='text' value="${bean.snumber }"  name='snumber' id='snumberid' />
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <textarea class="input-xlarge textarea" placeholder='请输入选定理由' name="result"  style="width: 500px; height: 150px">${bean.result }</textarea>
								</div>
							  </div>
