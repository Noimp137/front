			...
			<div class="row-fluid sortable">		
             ...
             &nbsp; 
						...
						<table class="table table-striped table-bordered ">
						  ...
						  <c:forEach items="${list}"  var="bean">
							<tr>
								...
								<c:if test="${bean.status=='未提交' }">
          		
              
          		<a href="${url2 }delete2.do?id=${bean.id }" class="btn btn-success btn-sm" onclick="return confirm('确定要提交审核吗?');"><i class="fa fa-remove"></i>提交审核</a>
                 &nbsp;
                </c:if>
				...
				<a href="${url2 }show.do?id=${bean.id }" class="btn btn-warning btn-sm"><i class="fa fa-eye"></i>查看</a>
          		...
          		&nbsp;
          		<a href="${url2 }delete.do?id=${bean.id }" class="btn btn-danger btn-sm" onclick="return confirm('确定要取消吗?');"><i class="fa fa-remove"></i>取消</a>
