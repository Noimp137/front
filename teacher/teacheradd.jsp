						...
						<form class="form-horizontal" action="${url }" method="post" onsubmit="return checkform()">
							<fieldset>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input  type='text' placeholder='请输入工号'  name='jobno' id='jobnoid' class="input-xlarge focused"/>
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input  type='text' placeholder='请输入姓名'  name='name' id='nameid' class="input-xlarge focused"/>
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input  type='text' placeholder='请输入年龄'  name='age' id='ageid' class="input-xlarge focused"/>
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input  type='text' placeholder='请输入手机号码'  name='phone' id='phoneid' class="input-xlarge focused"/>
								</div>
							  </div>
