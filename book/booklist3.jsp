	...
	<!-- topbar ends -->
		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">		
             ...
             <input type="text" class="form-control"  placeholder="请输入所属课程" name="cname" value="${cname }">
             &nbsp; 
             ...
             &nbsp; 
				...
				<a href="${url2 }show.do?id=${bean.id }" class="btn btn-warning btn-sm"><i class="fa fa-eye"></i>查看详情</a>
          		...
          		<a href="orders/ordersadd.do?bookid=${bean.id }" class="btn btn-danger btn-sm" onclick="return confirm('确定要订购教材吗?');"><i class="fa fa-remove"></i>订购教材</a>
