...
function checkform()
{
	...
	if (document.getElementById('bnumberid').value=="")
	{
		alert("教材编号不能为空");
		return false;
	}
						...
						<form class="form-horizontal" action="${url }" method="post" onsubmit="return checkform()" enctype="multipart/form-data" >
							...
							<div class="control-group">
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" type='text' placeholder='请输入教材编号'  name='bnumber' id='bnumberid' />
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" type='text' placeholder='请输入教材类别'  name='bcategory' id='bcategoryid' />
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" type='text' placeholder='请输入教材名称'  name='bname' id='bnameid' />
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused"  type="file"  name="uploadfile" id="uploadfileid"  placeholder='请上传教材封面'  />
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" type='text' placeholder='请输入作者'  name='author' id='authorid' />
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" type='text' placeholder='请输入出版社'  name='press' id='pressid' />
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" type='text' placeholder='请输入单价(元)'  name='price' id='priceid' />
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <textarea class="input-xlarge textarea" placeholder='请输入教材介绍' name="intro"  style="width: 500px; height: 150px"></textarea>
								</div>
							  </div>
