						...
						<form class="form-horizontal" action="${url }" method="post" onsubmit="return checkform()">
							<fieldset>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" type='text' value="${bean.college }"  name='college' id='collegeid' />
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" type='text' value="${bean.major }"  name='major' id='majorid' />
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" type='text' value="${bean.sessioninfo }"  name='sessioninfo' id='sessioninfoid' />
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" type='text' value="${bean.classname }" name='classname' id='classnameid' />
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" type='text' placeholder='请输入学生人数' value="${bean.stunumber }"  name='stunumber' id='stunumberid' />
								</div>
							  </div>
